...
def generate_usernames(first_name, last_name):
    ...
    # Add additional requested combinations
    usernames.append(first_name.lower() + '.' + last_name.lower())
    usernames.append(first_name[0].lower() + last_name.lower())
    usernames.append(first_name.lower() + last_name[0].lower())
    usernames.append(first_name[0].lower() + '.' + last_name[0].lower())
    usernames.append(first_name.lower() + last_name.lower() + '1')
    usernames.append(first_name.lower() + '_' + last_name.lower())
    # Add firstnamelastname combination
    usernames.append(first_name.lower() + last_name.lower())
    return usernames
